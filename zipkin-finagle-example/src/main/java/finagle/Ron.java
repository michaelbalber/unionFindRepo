...
public class Ron extends Service<Request, Response> {

  final Service<Request, Response> backendClient;

  Ron(Service<Request, Response> backendClient) {
  ...
  public static void main(String[] args) {
    ...
    new Flags("ron", true, true).parseOrExit1(args, false);
    ...
    Service<Request, Response> backendClient =
        ClientBuilder.safeBuild(ClientBuilder.get()
            ...
            .name("ron")); // this assigns the local service name

    ServerBuilder.safeBuild(
        new Ron(backendClient),
        ServerBuilder.get()
            .tracer(tracer)
            .codec(Http.get().enableTracing(true))
